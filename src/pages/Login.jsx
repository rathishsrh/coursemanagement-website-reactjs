...
export const Login = () => {
  ...
  async function handleSubmit(e){
      ...
      if(data.role=="admin")
      {
        res = await axios.get(`https://coursemanagement-backend-tqsi.onrender.com/admin?email=${data.email}&password=${data.password}`)
      }
      else {
        res = await axios.get(`https://coursemanagement-backend-tqsi.onrender.com/users?email=${data.email}&password=${data.password}`)
      }
